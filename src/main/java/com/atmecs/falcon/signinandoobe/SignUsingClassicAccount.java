...
public class SignUsingClassicAccount extends TestSuiteBase{
	...
	@Test
	public void signUsingClassicAccount() throws Exception
	{
		
		commonmethods= new CommonMethods(driver,prop);
		commonmethods.testLogin(testData,"classicusername","classicpassword");
		...
		VerificationManager.verifyString(driver.findElementById(prop.getProperty("homescreen.todaysdate")).getText(),"TODAY", "Logged in successfully using account created in Classic app");
